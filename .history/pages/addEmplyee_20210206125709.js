...
function addEmplyee(props) {
  ...
  const onSubmit = (data) => {
    ...
    e.preventDefault();
    axios.post("http://localhost:3005/employees", data).then((response) => {
  ...
  return (
    ...
    >
      <div className="mb-8">
        ...
        />
        {errors.empid && (
          <p className="ml-10 text-xs text-error">{errors.empid.message}</p>
        )}
      </div>
      <div className="mb-8">
      ...
      <div className="mb-8">
        ...
        {errors.empstatus && (
          <p className="ml-10 text-xs text-error">{errors.empstatus.message}</p>
        )}
      </div>
